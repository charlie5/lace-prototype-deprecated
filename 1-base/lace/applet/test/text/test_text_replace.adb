...
begin
   ...
   declare
      Initial : constant lace.Text.item :=  to_Text ("<TOKEN>");
   ...
   declare
      Initial : constant lace.Text.item :=  to_Text ("123<TOKEN>456");
      Final   : constant String         := +replace (Initial, "<TOKEN>", "Linux");
   begin
   ...
   declare
      Initial : constant lace.Text.item :=  to_Text ("123<TOKEN>");
      Final   : constant String         := +replace (Initial, "<TOKEN>", "Linux");
   begin
      if Final /= "123Linux"
      then
   ...
   declare
      Initial : constant lace.Text.item :=  to_Text ("<TOKEN>456");
      Final   : constant String         := +replace (Initial, "<TOKEN>", "Linux");
   begin
      if Final /= "Linux456"
      then
   ...
   declare
      Initial : constant lace.Text.item :=  to_Text ("<TOKEN>123<TOKEN>");
      Final   : constant String         := +replace (Initial, "<TOKEN>", "Linux");
   begin
   ...
   declare
      Initial : constant lace.Text.item :=  to_Text ("<TOKEN><TOKEN>");
      Final   : constant String         := +replace (Initial, "<TOKEN>", "Linux");
   begin
      if Final /= "LinuxLinux"
      then
   ...
   declare
      Initial : constant lace.Text.item := to_Text ("<TOKEN>", capacity => 64);
