...
package body impact.d2.orbs.Island
is
   ...
   procedure Add (Self : in out b2Island;   Solid       : access impact.d2.orbs.Solid.item'Class)
   is
   begin
   ...
   procedure Add (Self : in out b2Island;   Contact     : access impact.d2.orbs.Contact.b2Contact'Class)
   is
   begin
   ...
   procedure Add (Self : in out b2Island;   Joint       : access impact.d2.orbs.Joint.b2Joint'Class)
   is
   begin
