...
package impact.d2.orbs.Contact
--
--
--
is
   ...
   type b2ContactCreateFcn  is access function  (fixtureA, fixtureB : access Fixture.item) return access b2Contact'Class;
   type b2ContactDestroyFcn is access procedure (contact            : in out impact.d2.orbs.Contact.view);
   ...
   type b2ContactEdge is
      record
        other   : access Solid.Item'Class;   -- provides quick access to the other body attached.
        contact :        impact.d2.orbs.Contact.view;   -- the contact
...
private
   ...
   type b2Contact is abstract tagged
      record
        ...
        m_fixtureA : access Fixture.item;
        m_fixtureB : access Fixture.item;
...
--                        kindA, kindB : in     shape.Kind);   -- tbd: There appears to be no 'body' for this in the original C code
   ...
   s_registers   : array (1 .. 1, 1 .. 1) of b2ContactRegister;
