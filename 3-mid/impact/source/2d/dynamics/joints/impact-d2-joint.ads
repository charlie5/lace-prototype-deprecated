...
is
   ...
   type Solid_view is access all impact.d2.Solid.b2Body'Class;
   ...
   type b2JointEdge is
      record
        other : Solid_view; -- access Solid.b2Body'Class;        -- provides quick access to the other body attached.
        joint : impact.d2.Joint.view;           -- the joint
