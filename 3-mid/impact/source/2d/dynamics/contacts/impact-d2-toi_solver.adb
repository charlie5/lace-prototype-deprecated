...
package body impact.d2.toi_Solver
is
   ...
   procedure Initialize (Self : in out b2TOISolver;   contacts : in     Contact.views;
                                                      toiBody  : access Solid.b2Body'Class)
   is
   begin
      Self.clear;
      ...
      for i in 1 .. Self.m_count loop
         declare
            use impact.d2.Fixture;

            contact  : constant impact.d2.Contact.view := contacts (i);
   ...
   is
      ...
      bodyA,
      bodyB           : access Solid.b2Body'Class;
