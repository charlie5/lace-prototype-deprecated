...
package body openGL.Model.box.lit
is
   ...
   function new_Box (Size  : in Vector_3;
                     Faces : in lit.Faces) return View
   is
   ...
   is
      ...
      function new_Face (Vertices : access geometry.lit.Vertex_array) return Geometry_view
      is
         use openGL.Primitive;

         the_Geometry  : constant Geometry_view  := Geometry.lit.new_Geometry
   ...
   begin
      ...
      --
      declare
         the_Vertices : aliased Geometry.lit.Vertex_array
