         ...
         begin
            ...
            then
               ...
               begin
                  ...
                  light_ambient_color_Uniform .Value_is (Light. ambient_Color);
                  light_diffuse_color_Uniform .Value_is (Light. diffuse_Color);
                  light_specular_color_Uniform.Value_is (Light.specular_Color);
               end;
            end if;
         end;
      end loop;
