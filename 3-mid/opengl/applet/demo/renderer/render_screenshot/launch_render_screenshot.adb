...
--                                                                  size    => (1.0, 1.0),
      ...
      the_box_Model_1 : constant openGL.Model.box.colored.view
        := openGL.Model.box.colored.new_Box (size => (1.0, 2.0, 3.0),
...
--            (scale         => (1.0, 1.0, 1.0),
      ...
      the_capsule_Model : constant openGL.Model.capsule.lit_colored_textured.view
        := openGL.Model.capsule.lit_colored_textured.new_Capsule (radius => 1.0,
                                                                  height => 3.0,
                                                                  color  => (Green, Opaque),
                                                                  image  => the_Texture);
      ...
      the_hexagon_Model : constant openGL.Model.hexagon.lit_colored_textured.view
        := openGL.Model.hexagon.lit_colored_textured.new_Hexagon (radius => 1.0,
      ...
      the_faceted_hexagon_column_Model : constant openGL.Model.hexagon_Column.lit_colored_textured_faceted.view
        := openGL.Model.hexagon_Column.lit_colored_textured_faceted.new_hexagon_Column (radius => 1.0,
                                                                                        height => 2.0,
      ...
      the_rounded_hexagon_column_Model : constant openGL.Model.hexagon_Column.lit_colored_textured_rounded.view
        := openGL.Model.hexagon_Column.lit_colored_textured_rounded.new_hexagon_Column (radius => 1.0,
                                                                                        height => 2.0,
                                                                                        upper => (center_Color => (Green, Opaque),
                                                                                                  colors       => (others => (Red, Opaque)),
                                                                                                  texture      => <>),
...
--                                                   Texture_is_lucid => False);
      ...
      the_Region       : constant opengl.io.height_Map_view   := opengl.io.to_height_Map (to_Asset (heights_File), 10.0);
      ...
      the_Sprites : openGL.Visual.views
