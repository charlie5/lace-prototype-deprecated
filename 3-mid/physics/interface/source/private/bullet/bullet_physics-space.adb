...
is
   ...
   is
   begin
      raise physics.Space.unsupported_Error with "circle shape not allowed in bullet_Physics";
      return null;
   ...
   overriding
   function  new_polygon_Shape (Self : access Item;   Vertices : in physics.Space.polygon_Vertices)
                                           return physics.Shape .view
   is
   begin
      raise physics.Space.unsupported_Error with "polygon shape not allowed in bullet_Physics";
      return null;
   ...
   is
      pragma Unreferenced (Self);
      the_Joint : constant physics.Joint.hinge.view := bullet_physics.Joint.new_hinge_Joint (Sprite_A, Frame_A);
   begin
      return the_Joint;
   end new_hinge_Joint;
   ...
   is
      pragma Unreferenced (Self);
      the_Joint : constant physics.Joint.hinge.view := bullet_physics.Joint.new_hinge_Joint (Sprite_A, Sprite_B,
                                                                                             Frame_A,  Frame_B);
   begin
      return the_Joint;
   end new_hinge_Joint;
   ...
   is
      pragma Unreferenced (Self);
      the_Joint : constant physics.Joint.DoF6.view := bullet_physics.Joint.new_DoF6_Joint (Sprite_A, Sprite_B,
                                                                                           Frame_A,  Frame_B);
   begin
      return the_Joint;
   end new_DoF6_Joint;
   ...
   is
      pragma Unreferenced (Self);
      the_Joint : constant physics.Joint.ball.view := Standard.bullet_physics.Joint.new_ball_Joint (Sprite_A,    Sprite_B,
   ...
   is
      pragma Unreferenced (Self);
      the_Joint : constant physics.Joint.slider.view := bullet_physics.Joint.new_slider_Joint (Sprite_A, Sprite_B,
                                                                                               Frame_A,  Frame_B);
   begin
      return the_Joint;
   ...
   is
      pragma Unreferenced (Self);
      the_Joint : constant physics.Joint.cone_twist.view := bullet_physics.Joint.new_cone_twist_Joint (Sprite_A, Sprite_B,
                                                                                                       Frame_A,  Frame_B);
   begin
      return the_Joint;
   ...
   is
      the_c_Object : constant Object_Pointer := bullet_physics.Object.view (the_Object).C;
   begin
   ...
   is
      the_c_Joint : constant Joint_Pointer := bullet_physics.Joint.view (the_Joint).C;
   begin
