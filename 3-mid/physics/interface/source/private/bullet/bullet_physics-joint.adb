...
is
   ...
   is
      use type Swig.bool;
   begin
      return b3d_Joint_is_Limited (Self.C, Degree_of_freedom'Pos (DoF))  /=  0;
   end is_Limited;
   ...
   begin
      ...
      b3d_Joint_Velocity_is (Self.C, interfaces.C.int (DoF),
                                     c_math_c.Real (Now));
   end Velocity_is;
   ...
   begin
      ...
      return Real (b3d_Joint_Extent (Self.C,  interfaces.C.int (DoF)));
   end Extent;
   ...
   is
   begin
      return Real (b3d_Joint_6DoF_lower_Limit (Self.C, interfaces.C.int (DoF)));
   end lower_Limit;
   ...
   is
   begin
      return Real (b3d_Joint_6DoF_upper_Limit (Self.C, interfaces.C.int (DoF)));
   end upper_Limit;
   ...
   is
   begin
      b3d_Joint_6DoF_lower_Limit_is (Self.C, interfaces.C.int (DoF),
                                             c_math_c.Real (Now));
   end lower_Limit_is;
   ...
   is
   begin
      b3d_Joint_6DoF_upper_Limit_is (Self.C, interfaces.C.int (DoF),
                                             c_math_c.Real (Now));
   end upper_Limit_is;
   ...
   begin
      ...
      b3d_Joint_Velocity_is (Self.C, interfaces.C.int (Now),
                                     c_math_c.Real (DoF));
   end Velocity_is;
