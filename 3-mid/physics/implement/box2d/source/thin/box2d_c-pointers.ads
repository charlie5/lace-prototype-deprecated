...
package box2d_c.Pointers is
   ...
   type Shape_Pointers is
     array
       (Interfaces.C
          .size_t range <>) of aliased box2d_c.Pointers.Shape_Pointer;
   ...
   type Object_Pointers is
     array
       (Interfaces.C
          .size_t range <>) of aliased box2d_c.Pointers.Object_Pointer;
   ...
   type Joint_Pointers is
     array
       (Interfaces.C
          .size_t range <>) of aliased box2d_c.Pointers.Joint_Pointer;
   ...
   type Space_Pointers is
     array
       (Interfaces.C
          .size_t range <>) of aliased box2d_c.Pointers.Space_Pointer;
   ...
   -- b2Joint_Pointers
   --
   type b2Joint_Pointers is
     array
       (Interfaces.C
          .size_t range <>) of aliased box2d_c.Pointers.b2Joint_Pointer;
