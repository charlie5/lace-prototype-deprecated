...
package box2d_c.Binding is
   ...
   function b2d_new_Circle
     (Radius : in c_math_c.Real) return access box2d_c.Shape;

   function b2d_new_Polygon
     (Vertices     : in c_math_c.Vector_2.Pointer;
      vertex_Count : in Interfaces.C.int) return access box2d_c.Shape;

   function b2d_new_Box
     (half_Extents : in c_math_c.Vector_3.Pointer) return access box2d_c.Shape;

   function b2d_new_Capsule
     (Radii  : in c_math_c.Vector_2.Pointer;
      Height : in c_math_c.Real) return access box2d_c.Shape;
   ...
   function b2d_new_convex_Hull
     (Points      : in c_math_c.Vector_3.Pointer;
      point_Count : in Interfaces.C.int) return access box2d_c.Shape;
   ...
   function b2d_new_Heightfield
     (Width      : in Interfaces.C.int;
      ...
      Scale      : in c_math_c.Vector_3.Pointer) return access box2d_c.Shape;

   function b2d_new_multiSphere
     (Positions    : in c_math_c.Vector_3.Pointer;
      Radii        : in c_math_c.Pointers.Real_Pointer;
      sphere_Count : in Interfaces.C.int) return access box2d_c.Shape;

   function b2d_new_Plane
     (Normal : in c_math_c.Vector_3.Pointer;
      Offset : in c_math_c.Real) return access box2d_c.Shape;
   ...
   function b2d_Object_Shape
     (Self : in box2d_c.Pointers.Object_Pointer) return access box2d_c.Shape;
   ...
   function b2d_new_hinge_Joint_with_local_anchors
     (in_Space          : in box2d_c.Pointers.Space_Pointer;
      ...
      collide_Connected : in Swig.bool) return access box2d_c.Joint;
   ...
   function b2d_new_space_hinge_Joint
     (Object_A : in box2d_c.Pointers.Object_Pointer;
      Frame_A  : in c_math_c.Matrix_4x4.Pointer) return access box2d_c.Joint;

   function b2d_new_DoF6_Joint
     (Object_A : in box2d_c.Pointers.Object_Pointer;
      Object_B : in box2d_c.Pointers.Object_Pointer;
      Frame_A  : in c_math_c.Matrix_4x4.Pointer;
      Frame_B  : in c_math_c.Matrix_4x4.Pointer) return access box2d_c.Joint;
   ...
   function b2d_new_ball_Joint
     (Object_A   : in box2d_c.Pointers.Object_Pointer;
      ...
      Pivot_in_B : in c_math_c.Vector_3.Pointer) return access box2d_c.Joint;

   function b2d_Joint_user_Data
     (Self : in box2d_c.Pointers.Joint_Pointer) return Swig.void_ptr;

   procedure b2d_Joint_user_Data_is
     (Self : in box2d_c.Pointers.Joint_Pointer;
      Now  : in Swig.void_ptr);

   function b2d_Joint_Object_A
     (Self : in box2d_c.Pointers.Joint_Pointer) return access box2d_c.Object;
   ...
   function b2d_new_Space return access box2d_c.Space;
   ...
   function b2d_Space_joint_Element
     (Cursor : in box2d_c.joint_Cursor.Pointer) return access box2d_c.b2Joint;
...
private
   ...
   pragma Import
     (C,
      b2d_Object_Restitution_is,
      "Ada_b2d_Object_Restitution_is");
   ...
   pragma Import
     (C,
      b2d_Object_apply_Torque_impulse,
   ...
   pragma Import
     (C,
      b2d_new_space_hinge_Joint,
      "Ada_b2d_new_space_hinge_Joint");
   ...
   pragma Import
     (C,
      b2d_Joint_set_local_Anchor,
      "Ada_b2d_Joint_set_local_Anchor");
   ...
   pragma Import
     (C,
      b2d_Joint_reaction_Torque,
      "Ada_b2d_Joint_reaction_Torque");
   pragma Import
     (C,
      b2d_Joint_hinge_Limits_are,
      "Ada_b2d_Joint_hinge_Limits_are");
