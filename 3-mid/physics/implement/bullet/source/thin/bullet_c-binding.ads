...
package bullet_c.Binding is
   ...
   function b3d_new_Box
     (half_Extents : in c_math_c.Vector_3.Pointer)
      return access bullet_c.Shape;

   function b3d_new_Capsule
     (Radii  : in c_math_c.Vector_2.Pointer;
      Height : in c_math_c.Real) return access bullet_c.Shape;
   ...
   function b3d_new_convex_Hull
     (Points      : in c_math_c.Vector_3.Pointer;
      point_Count : in Interfaces.C.int) return access bullet_c.Shape;
   ...
   function b3d_new_Heightfield
     (Width      : in Interfaces.C.int;
      ...
      Scale      : in c_math_c.Vector_3.Pointer) return access bullet_c.Shape;

   function b3d_new_multiSphere
     (Positions    : in c_math_c.Vector_3.Pointer;
      Radii        : in c_math_c.Pointers.Real_Pointer;
      sphere_Count : in Interfaces.C.int) return access bullet_c.Shape;

   function b3d_new_Plane
     (Normal : in c_math_c.Vector_3.Pointer;
      Offset : in c_math_c.Real) return access bullet_c.Shape;

   function b3d_new_Sphere
     (Radius : in c_math_c.Real) return access bullet_c.Shape;
   ...
   function b3d_new_Object
     (Mass         : in c_math_c.Real;
      ...
      is_Kinematic : in Interfaces.C.int) return access bullet_c.Object;

   function b3d_Object_Shape
     (Self : in bullet_c.Pointers.Object_Pointer) return access bullet_c.Shape;
   ...
   function b3d_new_hinge_Joint
     (Object_A : in bullet_c.Pointers.Object_Pointer;
      ...
      Frame_B  : in c_math_c.Matrix_4x4.Pointer) return access bullet_c.Joint;

   function b3d_new_space_hinge_Joint
     (Object_A : in bullet_c.Pointers.Object_Pointer;
      Frame_A  : in c_math_c.Matrix_4x4.Pointer) return access bullet_c.Joint;
   ...
   function b3d_new_ball_Joint
     (Object_A   : in bullet_c.Pointers.Object_Pointer;
      ...
      Pivot_in_B : in c_math_c.Vector_3.Pointer) return access bullet_c.Joint;
   ...
   function b3d_Joint_Object_A
     (Self : in bullet_c.Pointers.Joint_Pointer) return access bullet_c.Object;
   ...
   function b3d_new_Space return access bullet_c.Space;
